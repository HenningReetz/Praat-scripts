...
nr_judgments = 3
judgment_name$ = "Voicing"
judgment$# = {"Voiced","Voiceless","Unsure"}
...
procedure CheckPraatVersion
	...
	if (praat_version<lowest_praat_version or praat_revision<lowest_praat_revision or praat_fix<lowest_praat_fix)
